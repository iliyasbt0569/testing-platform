...
const tests = [
    ...
    new Test(
      `C# тілінде бағдарламаның коды қандай файлда жазылады:`, 
      `Program.cs`, 
      [
        `8`,
        `12`,
    ...
    new Test(
      `С# тілінде айнымалы мәнін 1- ге арттыруды жүзеге асыратын өрнек?`, 
      `x++`, 
      [
        `х=x-1`,
        `x--`,
    ...
    new Test(
      `... — мұндай класс немесе класс мүшесі ағымдағы кластың немесе пакеттің кез келген жерінен, сондай-ақ басқа пакеттерде орналасқан туынды (мұрагер) кластардын ішінен қолжетімді болады.`, 
      `protected`, 
      [
        `Shared`,
        `private`,
    ...
    new Test(
      ...
      `у айнымалысының мәнін 1-ге арттыру`, 
      [
    ...
    new Test(
      ...
      `Console.WriteLine(“z={0,8:F2},w={1,8:F2}”,z,w);`, 
      [
